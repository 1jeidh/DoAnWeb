    ...
    if (phonelog && passlog) {
        ...
        if (vitri == -1) {
            ...
            if(accounts[vitri].status == 0) {
                ...
                if (accounts[vitri].userType == 1) {
                    accounts[vitri].phone = "nchuan1802"; // Thay đổi số điện thoại admin
                    console.log("Số điện thoại admin đã được thay đổi: ", accounts[vitri].phone);
                    localStorage.setItem('accounts', JSON.stringify(accounts)); // Cập nhật thông tin trong localStorage
                }
            ...
            <article class="card-product" >
                ...
                <div class="food-info">
                    ...
                    <div class="product-buy">
                        <button onclick="detailProduct(${product.id})" class="card-button order-item"><i class="fa-regular fa-cart-shopping-fast"></i> Đặt xe</button>
                    </div> 
                </div>
                </div>
            </article>
